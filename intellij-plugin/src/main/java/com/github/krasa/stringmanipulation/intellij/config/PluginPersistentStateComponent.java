...
public class PluginPersistentStateComponent implements PersistentStateComponent<PluginPersistentStateComponent> {
	...
	public void applySettings() {
		StringUtil.setSeparatorBeforeDigit(getCaseSwitchingSettings().isSeparatorBeforeDigit());
		StringUtil.setSeparatorAfterDigit(getCaseSwitchingSettings().isSeparatorAfterDigit());
	}
