package com.github.krasa.stringmanipulation.commons;
...
//        assertEquals("whoahATest", StringUtil.toCamelCase("WhOAh a_TeSt"));
    ...
    public void testWordsAndCamelToConstantCase() {
        StringUtil.setSeparatorAfterDigit(true);
        StringUtil.setSeparatorBeforeDigit(true);
        ...
        StringUtil.setSeparatorAfterDigit(true);
        StringUtil.setSeparatorBeforeDigit(false);
