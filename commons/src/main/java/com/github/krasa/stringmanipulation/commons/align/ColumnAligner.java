package com.github.krasa.stringmanipulation.commons.align;
...
public class ColumnAligner {
	private static final Logger LOG = Logger.getLogger("com.github.krasa.stringmanipulation.utils.align.ColumnAligner");
	...
	protected List<ColumnAlignerLine> sortLines(List<ColumnAlignerLine> lines) {
		try {
			lines = sort(lines);
		} catch (SortFailedException e) {
			LOG.log(Level.FINE, "sort failed",e);
		} catch (Exception e) {
			LOG.log(Level.WARNING, "sort failed",e);
		}
		return lines;
	}

	protected List<ColumnAlignerLine> sort(List<ColumnAlignerLine> lines) {
