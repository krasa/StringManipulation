...
//		System.out.println("Scrambled: " + scrambled);
	...
	private static void numbersWithSigns() {
		...
		unSorted.sort(new com.github.krasa.stringmanipulation.utils.sort.paour.NaturalOrderComparator());
	...
	static void shuffle3000(List<? extends Object> scrambled) {
		...
		Collections.sort(scrambled, new com.github.krasa.stringmanipulation.utils.sort.paour.NaturalOrderComparator());

		System.out.println("Sorted: " + scrambled);
	}

	static void compareSymmetric() {
		com.github.krasa.stringmanipulation.utils.sort.paour.NaturalOrderComparator naturalOrderComparator = new com.github.krasa.stringmanipulation.utils.sort.paour.NaturalOrderComparator();
