...
public class ToKebabOrCamelCaseCaseActionTest extends CaseSwitchingTest {
	protected ToKebabOrCamelCaseCaseAction action;

	@Test
	public void testTransform() throws Exception {
		action = new ToKebabOrCamelCaseCaseAction(false);
